...
__all__ = [
    'ISpObjectWithToken', 'SPDKL_LocalMachine', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRIsUISupported', 'SpeechTokenValueCLSID',
    'SREStreamStart', 'SVEPrivate', 'ISpRecoContext2',
    'SPSHT_Unknown', 'SVSFlagsAsync', 'DISPID_SOTsItem',
    'SRADefaultToActive', 'eLEXTYPE_RESERVED8', 'eLEXTYPE_PRIVATE20',
    'SPEI_TTS_PRIVATE', 'SDTLexicalForm',
    'DISPID_SRSetPropertyString', 'SAFT8kHz8BitStereo', 'SPEVENT',
    'DISPID_SVSInputWordPosition', 'SPEI_RESERVED6',
    'SAFT48kHz8BitMono', 'SpeechGrammarWordType',
    'SpeechVoiceCategoryTTSRate', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SAFSetWaveFormatEx', 'SPEI_RESERVED5',
    'DISPID_SGRSTransitions', 'SPWORDPRONOUNCEABLE',
    'SAFTADPCM_8kHzMono', 'DISPID_SPPConfidence', 'SDKLLocalMachine',
    'SREPropertyNumChange', 'SPPHRASEREPLACEMENT',
    'DISPID_SVSpeakStream', 'SpeechGrammarTagWildcard',
    'ISpGrammarBuilder', 'DISPID_SWFEAvgBytesPerSec',
    'SpPhoneConverter', 'SAFT22kHz8BitStereo',
    'DISPID_SVEStreamStart', 'DISPID_SRRSetTextFeedback',
    'ISpeechRecoResultDispatch', 'SPEI_REQUEST_UI',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE2', 'SpInProcRecoContext',
    'SPSHT_NotOverriden', 'DISPID_SLAddPronunciation',
    'DISPID_SRRPhraseInfo', 'DISPID_SAFGuid', 'DISPID_SRStatus',
    'eLEXTYPE_PRIVATE9', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPPsCount',
    'DISPID_SVGetVoices', 'SAFT44kHz8BitStereo', 'DISPID_SGRsCount',
    'SVP_10', 'SPVPRIORITY', 'IStream', 'DISPID_SVIsUISupported',
    'SP_VISEME_19', 'SpeechVoiceSpeakFlags', 'DISPID_SMSSetData',
    'DISPID_SLWType', 'ISpeechPhraseElements', 'SITooSlow', 'SLTApp',
    'ISpLexicon', 'SpeechTokenContext', 'DISPID_SRState',
    'DISPID_SpeechPhraseElements', 'WAVEFORMATEX',
    'DISPID_SVPriority', 'ISpMMSysAudio', 'SDTProperty',
    'SVEAudioLevel', 'DISPID_SRCRecognizer', 'SWTAdded', 'SGDisplay',
    'DISPID_SRCESoundEnd', 'DISPID_SVStatus', 'SVP_15',
    'SpMemoryStream', 'SRADynamic', 'SAFT11kHz8BitStereo',
    'SpResourceManager', 'SPSFunction', 'SVF_Emphasis',
    'eLEXTYPE_RESERVED6', 'SAFT8kHz16BitStereo', 'SPPS_Interjection',
    'SPAUDIOBUFFERINFO', 'SVSFParseSsml', 'SGDSActive',
    'DISPID_SOTGetAttribute', 'SRSEIsSpeaking', 'DISPID_SRCVoice',
    'DISPID_SRRecognizer', 'DISPID_SAEventHandle',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPAsItem',
    'UINT_PTR', 'SPPS_Function', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechRecoResult2', 'DISPID_SRRAudio',
    'DISPID_SRGCmdSetRuleState', 'ISpeechRecoGrammar', 'SPBO_AHEAD',
    'DISPID_SVSkip', 'DISPID_SRSSupportedLanguages',
    'SpCompressedLexicon', 'SP_VISEME_4', 'SPWORDTYPE', 'SITooLoud',
    'SREBookmark', 'ISpResourceManager', 'DISPID_SPCIdToPhone',
    'SpeechRegistryLocalMachineRoot', 'ISpeechVoice', 'SINone',
    'SPPS_Modifier', 'SpeechSpecialTransitionType', 'SRESoundStart',
    'DISPID_SRGCommit', 'SVSFPurgeBeforeSpeak', 'LONG_PTR',
    'DISPID_SRRTimes', 'SREPhraseStart', 'SPSModifier',
    ...
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTCDefault',
    'SSSPTRelativeToStart', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRProfile', 'SPAO_NONE', 'SPEI_RECOGNITION',
    'SpeechGrammarState', 'DISPID_SpeechPhraseReplacement',
    'SPAS_RUN', 'ISpObjectToken', 'SPPS_RESERVED2',
    'DISPID_SpeechFileStream', 'IInternetSecurityMgrSite',
    'SRAImport', 'SP_VISEME_13', 'SPFM_OPEN_READONLY',
    'SpeechInterference', 'SRERecoOtherContext', 'DISPID_SRRTLength',
    'eLEXTYPE_LETTERTOSOUND', 'SPEI_RESERVED2', 'DISPID_SPRulesCount',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPPEngineConfidence', 'SVP_8', 'DISPID_SDKGetStringValue',
    'SDKLDefaultLocation', 'SpeechAddRemoveWord',
    'DISPID_SRCRequestedUIType', 'SpeechGrammarTagDictation',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPPFirstElement',
    'DISPID_SBSFormat', 'ISpeechLexiconWord', 'SpeechVisemeType',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechObjectToken',
    'SPXMLRESULTOPTIONS', 'DISPID_SpeechMemoryStream',
    'SAFT12kHz16BitMono', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SPACommit', 'DISPID_SpeechLexicon', 'SP_VISEME_7',
    'DISPID_SRRRecoContext', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRCVoicePurgeEvent', 'SAFTNoAssignedFormat', 'SLTUser',
    'SVEEndInputStream', 'SAFT11kHz8BitMono', 'DISPID_SPIElements',
    'DISPID_SGRsItem', 'DISPID_SDKEnumKeys',
    'SpeechPropertyAdaptationOn', 'DISPID_SRGCmdLoadFromObject',
    'SVF_None', 'SGDSActiveWithAutoPause',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVEWordBoundary',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SASCurrentDevicePosition',
    'SVP_14', 'SpeechRegistryUserRoot', 'DISPID_SGRs_NewEnum',
    'DISPID_SDKGetBinaryValue', 'SAFT24kHz16BitMono', 'SP_VISEME_2',
    'SRSInactive', 'DISPID_SRCAudioInInterferenceStatus',
    'SPSEMANTICERRORINFO', 'SpPhoneticAlphabetConverter',
    'eLEXTYPE_PRIVATE5', 'SAFT48kHz16BitStereo', 'ISpeechBaseStream',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SVEWord', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRCEInterference', 'SP_VISEME_9', 'SGRSTTRule',
    'SRATopLevel', 'eLEXTYPE_RESERVED9', 'SGSExclusive',
    '_RemotableHandle', 'SRSInactiveWithPurge',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpShortcut', 'DISPID_SAFType',
    'ISpShortcut', 'DISPID_SGRSAddWordTransition',
    'ISpeechPhraseElement', 'SAFTNonStandardFormat',
    'SpeechVoiceEvents', 'SAFT32kHz8BitStereo', 'SPEI_MAX_SR',
    'DISPID_SASState', 'SSFMOpenReadWrite', 'SPPHRASERULE',
    'DISPID_SGRSTNextState', 'DISPID_SPRulesItem',
    'DISPID_SpeechAudioBufferInfo', 'SVSFIsFilename',
    'DISPID_SOTSetId', 'DISPID_SPPParent', 'SAFT24kHz8BitStereo',
    'DISPID_SRCERecognition', 'SpeechRecoEvents',
    'DISPID_SpeechPhraseBuilder', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVPause', 'ISpeechMMSysAudio', 'DISPID_SOTDisplayUI',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRDisplayUI',
    'DISPID_SVESentenceBoundary', 'ISpStreamFormat',
    'DISPID_SpeechLexiconProns', 'SAFT12kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SPRules_NewEnum',
    'DISPID_SCSBaseStream', 'SSTTTextBuffer', 'SPAUDIOSTATUS',
    'ISpeechGrammarRuleState', 'SVEPhoneme', 'SVPAlert',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVP_18',
    'eWORDTYPE_ADDED', 'SpeechCategoryRecoProfiles',
    ...
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPPs_NewEnum', 'SPLO_DYNAMIC',
    'DISPID_SVEAudioLevel', 'SVP_5', 'eLEXTYPE_PRIVATE11',
    'DISPID_SPIRetainedSizeBytes', 'SAFT12kHz8BitMono',
    'SP_VISEME_21', 'DISPID_SASetState', 'SVP_3',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPIAudioStreamPosition',
    'ISpStream', 'SP_VISEME_14', 'DISPID_SOTGetStorageFileName',
    'DISPID_SpeechObjectTokens', 'SpeechCategoryVoices',
    'ISequentialStream', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechPartOfSpeech', 'SGRSTTDictation', 'SVP_7', 'SpAudioFormat',
    '_SPAUDIOSTATE', 'SVSFVoiceMask', 'SPEI_PHONEME',
    'DISPID_SRGSetTextSelection', 'SPRST_NUM_STATES',
    'SPEI_SR_PRIVATE', 'DISPID_SPPNumberOfElements',
    'ISpeechAudioStatus', 'DISPID_SDKSetStringValue',
    'SpeechDataKeyLocation', 'SREStreamEnd',
    'DISPID_SpeechVoiceEvent', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRTOffsetFromStart', 'ISpRecoGrammar',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRSTPropertyName',
    'DISPID_SRGDictationUnload', 'DISPID_SPAPhraseInfo',
    'ISpeechPhraseReplacement', 'SpPhraseInfoBuilder',
    'eLEXTYPE_RESERVED7', 'DISPID_SDKDeleteValue', 'SPFM_CREATE',
    'ISpeechDataKey', 'SRESoundEnd', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRCreateRecoContext', 'DISPID_SOTCSetId',
    'ISpeechObjectToken', 'SPDATAKEYLOCATION', 'ISpeechObjectTokens',
    'SPRECOSTATE', 'DISPID_SRCBookmark', 'SPCT_SLEEP',
    'SPINTERFERENCE_TOOQUIET', 'SDKLCurrentConfig', 'DISPID_SLPType',
    'DISPID_SPEEngineConfidence', 'SPPS_SuppressWord', 'SRAExport',
    'SGDSActiveUserDelimited', 'SpUnCompressedLexicon',
    'SREFalseRecognition', 'DISPID_SWFESamplesPerSec', 'SVP_0',
    'DISPID_SGRSTs_NewEnum', 'SAFT32kHz16BitMono', 'SRTEmulated',
    'SPSERIALIZEDPHRASE', 'SPFILEMODE', 'SP_VISEME_12',
    'DISPID_SVAudioOutput', 'DISPID_SVDisplayUI', 'SSFMOpenForRead',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SLPsCount',
    'DISPID_SPRuleId', 'DISPID_SMSALineId', 'SPPHRASEELEMENT',
    ...
    'DISPID_SRRDiscardResultInfo', 'SPXRO_SML', 'SpMMAudioEnum',
    'SPSInterjection', 'SPSVerb', 'ISpEventSink', 'SpeechAudioState',
    'ISpeechPhraseAlternate', 'DISPID_SVSRunningState',
    'SPEI_VOICE_CHANGE', 'ISpeechLexiconPronunciation',
    'SAFT11kHz16BitStereo', 'DISPID_SGRSTType', 'SGRSTTWord',
    'IInternetSecurityManager', 'ISpSerializeState', 'SP_VISEME_15',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVP_6', 'SAFTText',
    'DISPIDSPRG', 'DISPID_SOTId', 'DISPID_SASCurrentSeekPosition',
    'SVSFParseAutodetect', 'ISpeechPhraseRule', 'SVP_21',
    'DISPID_SVGetProfiles', 'ISpPhrase', 'DISPID_SRGIsPronounceable',
    'ISpeechPhoneConverter', 'SpeechLexiconType',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_18', 'SPEI_ADAPTATION',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SVVolume',
    'eLEXTYPE_PRIVATE13', 'SPWORD', 'DISPID_SGRSTsCount',
    'DISPID_SMSADeviceId', 'DISPID_SRGState',
    'DISPID_SRGSetWordSequenceData', 'SASStop', 'SPPS_NotOverriden',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SVP_4', 'SPEVENTENUM',
    'SECFDefault', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPRsItem', 'DISPID_SPCPhoneToId',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_SOUND_START',
    'SPEI_INTERFERENCE', 'SAFT16kHz8BitStereo',
    'DISPID_SRRSaveToMemory', 'DISPID_SASNonBlockingIO',
    'DISPID_SRGReset', 'ISpPhoneticAlphabetConverter',
    'SPEI_FALSE_RECOGNITION', 'SRCS_Enabled', 'SPEI_SR_BOOKMARK',
    'DISPID_SLRemovePronunciation', 'SSTTDictation', 'DISPID_SGRsAdd',
    'DISPID_SOTsCount', 'SPGS_DISABLED', 'SVPOver', 'SP_VISEME_16',
    'DISPID_SLPsItem', 'DISPID_SRRSpeakAudio', 'eWORDTYPE_DELETED',
    'DISPID_SPAs_NewEnum', 'DISPID_SpeechRecoContext',
    'SREAudioLevel', 'SAFT24kHz16BitStereo',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPIReplacements',
    'DISPID_SVEStreamEnd', 'DISPID_SRCPause', 'SGPronounciation',
    'DISPID_SPIAudioSizeTime', 'SFTInput',
    'DISPID_SRGetPropertyNumber', 'SpNullPhoneConverter',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRSNumberOfActiveRules', 'SpSharedRecoContext',
    'SpeechTokenKeyFiles', 'SAFT8kHz16BitMono', 'SPEI_RESERVED3',
    'DISPID_SPISaveToMemory', 'SPAS_CLOSED', 'SpeechFormatType',
    'eLEXTYPE_PRIVATE18', 'SAFT32kHz8BitMono', 'SPEI_TTS_AUDIO_LEVEL',
    'SDA_Two_Trailing_Spaces', 'SpeechRetainedAudioOptions',
    'ISpeechXMLRecoResult', 'DISPID_SPRuleChildren',
    'DISPID_SPPChildren', 'ISpeechPhraseRules', 'SBONone',
    'SAFTADPCM_11kHzStereo', 'DISPID_SpeechAudioStatus',
    'SRERequestUI', 'DISPID_SOTGetDescription', 'DISPID_SRAudioInput',
    'SPBO_TIME_UNITS', 'SpeechAudioFormatGUIDText',
    'eLEXTYPE_PRIVATE14', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SVEViseme', 'SSFMCreate', 'SpFileStream',
    'DISPID_SpeechPhraseAlternate', 'SpeechAudioVolume',
    'DISPID_SpeechGrammarRules', 'DISPID_SOTRemove', 'SPCS_ENABLED',
    'DISPID_SLWsItem', 'SPAR_High', 'SPEI_PHRASE_START',
    'SPEI_SOUND_END', 'SPCT_SUB_COMMAND',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SLPSymbolic',
    'SPINTERFERENCE_TOOSLOW', 'SVP_13', 'SPPS_LMA', 'SRERecognition',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPPName',
    'DISPID_SOTDataKey', 'DISPID_SPIEngineId', 'SAFT16kHz8BitMono',
    'SPBO_PAUSE', 'DISPID_SPERetainedSizeBytes',
    'tagSPTEXTSELECTIONINFO', 'SpeechUserTraining', 'ISpRecoGrammar2',
    'SPSLMA', 'SDA_No_Trailing_Space', 'SVEBookmark',
    'DISPID_SGRAddState', 'SpeechMicTraining', 'SAFT32kHz16BitStereo',
    'SpeechCategoryAudioOut', 'DISPID_SLGetPronunciations',
    'SWTDeleted', 'DISPID_SPIAudioSizeBytes', 'SVSFNLPMask',
    'SPEI_MAX_TTS', 'SAFT12kHz16BitStereo', 'ISpRecognizer',
    'SPSHORTCUTPAIR', 'SP_VISEME_3', 'SpMMAudioIn',
    'ISpeechTextSelectionInformation', 'DISPID_SRGId',
    'DISPID_SWFEBitsPerSample', 'SPEI_UNDEFINED',
    'DISPIDSPTSI_SelectionLength', 'SP_VISEME_20', 'SpStream',
    'DISPID_SpeechRecognizer', 'DISPID_SRCESoundStart',
    'SPEI_RESERVED1', 'ISpeechRecoResultTimes', 'SPAR_Low',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechLexiconWords',
    'STSF_AppData', 'STSF_LocalAppData', 'DISPID_SPRsCount',
    'DISPID_SPARecoResult', 'DISPID_SRGetRecognizers',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRCEventInterests',
    'DISPID_SRCEPhraseStart', 'ISpNotifyTranslator', 'IEnumString',
    'SP_VISEME_10', 'DISPID_SLWLangId', 'SPPS_RESERVED1',
    'DISPID_SPCLangId', 'SPADAPTATIONRELEVANCE', 'SPLOADOPTIONS',
    'SPAS_STOP', 'SpeechBookmarkOptions', 'DISPID_SRAudioInputStream',
    'ISpeechFileStream', 'DISPID_SAStatus', 'SPBO_NONE',
    'SPWT_PRONUNCIATION', 'SPCS_DISABLED', 'DISPID_SFSOpen',
    'SPINTERFERENCE_NONE', 'SpStreamFormatConverter',
    'DISPID_SpeechGrammarRule', 'SpeechEngineConfidence',
    'STCLocalServer', 'DISPID_SpeechWaveFormatEx',
    'Speech_StreamPos_Asap', 'SPDKL_CurrentUser',
    'SpeechRecognitionType', 'SpeechRecoProfileProperties',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPAStartElementInResult',
    'DISPID_SpeechPhraseElement', 'SpCustomStream', 'SVPNormal',
    'ISpObjectTokenCategory', 'DISPID_SVResume', 'DISPID_SRIsShared',
    'SP_VISEME_17', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SPAsCount', 'DISPID_SpeechVoiceStatus', 'SGRSTTWildcard',
    'SpeechRuleAttributes', 'SECNormalConfidence',
    'DISPID_SVSLastResult', 'SVEViseme', 'DISPID_SPEActualConfidence',
    'ISpRecoCategory', 'DISPID_SLWPronunciations',
    'DISPID_SpeechPhoneConverter', 'SPTEXTSELECTIONINFO',
    'DISPID_SPRuleName', 'SpeechLoadOption', 'DISPID_SPRFirstElement',
    'SPPHRASEPROPERTY', 'SVSFIsXML', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCEBookmark', 'SAFT44kHz8BitMono', 'SPGS_ENABLED',
    'SPEI_MIN_SR', 'DISPID_SVVoice', 'SDTPronunciation',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVP_20', 'SGLexical',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechStreamSeekPositionType',
    'DISPID_SDKEnumValues', 'SpWaveFormatEx', 'DISPID_SOTCategory',
    'eLEXTYPE_RESERVED10', 'ISpDataKey', 'SpeechWordPronounceable',
    'DISPID_SpeechRecognizerStatus', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPSHORTCUTTYPE', 'SREInterference', 'DISPID_SDKCreateKey',
    ...
    'SpeechAudioFormatType', 'SAFTGSM610_11kHzMono',
    'SpeechRecoContextState', 'SASRun',
    'SWPUnknownWordUnpronounceable', 'STCRemoteServer',
    'DISPID_SBSSeek', 'ISpeechWaveFormatEx', 'DISPID_SOTCGetDataKey',
    'SPGRAMMARSTATE', 'SRTStandard', 'DISPID_SWFEFormatTag',
    'DISPID_SRRGetXMLResult', 'SpeechCategoryAudioIn',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechPhraseReplacements',
    'DISPID_SRGCmdSetRuleIdState', 'SSSPTRelativeToCurrentPosition',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRCEEndStream', 'ISpPhoneConverter',
    'DISPID_SpeechPhraseProperties', 'SPRS_INACTIVE',
    'SAFTGSM610_44kHzMono', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechAudio', 'SPAO_RETAIN_AUDIO', 'DISPID_SPPsItem',
    ...
    'DISPID_SBSWrite', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SGRsFindRule', 'SASClosed', 'SPPARTOFSPEECH',
    'DISPID_SPRText', 'SPEI_PROPERTY_STRING_CHANGE', 'SPVPRI_OVER',
    '_ISpeechRecoContextEvents', 'DISPID_SBSRead', 'SGRSTTEpsilon',
    'ISpAudio', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SVGetAudioOutputs',
    ...
    'SPINTERFERENCE_NOISE', 'SVP_19', 'eLEXTYPE_USER',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SMSGetData',
    'DISPID_SPRuleConfidence', 'SVSFIsNotXML',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGRules',
    'SECFIgnoreKanaType', 'DISPID_SRGDictationSetState', 'SPSMF_UPS',
    'SPEI_VISEME', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SGRSTText',
    'DISPID_SPEsItem', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPSUnknown', 'SVP_11', 'DISPID_SLWs_NewEnum',
    'DISPID_SVSInputSentencePosition', 'SDTAlternates',
    'DISPID_SGRName', 'eLEXTYPE_RESERVED4', 'SPCT_SUB_DICTATION',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPIGrammarId',
    'SWPKnownWordPronounceable', 'ISpeechLexicon',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPEAudioSizeBytes',
    'SpMMAudioOut', 'SITooFast', 'SPDKL_CurrentConfig',
    'SSSPTRelativeToEnd', 'SPVPRI_ALERT', 'DISPID_SGRSTsItem',
    'SPSTREAMFORMATTYPE', 'SpNotifyTranslator', 'SPWT_DISPLAY',
    'DISPID_SGRAttributes', 'SpSharedRecognizer', 'SPINTERFERENCE',
    'SP_VISEME_8', 'SAFT24kHz8BitMono',
    'DISPID_SPIGetDisplayAttributes',
    'SpeechPropertyHighConfidenceThreshold', 'SAFTADPCM_44kHzStereo',
    'SPVOICESTATUS', 'SDTDisplayText', 'DISPID_SpeechDataKey',
    'SPPS_RESERVED3', 'DISPID_SVGetAudioInputs', 'SPAUDIOOPTIONS',
    'DISPID_SPRuleParent', 'DISPID_SVWaitUntilDone',
    'DISPID_SABufferInfo', 'SDTAudio', 'SpeechCategoryAppLexicons',
    'eLEXTYPE_APP', 'DISPID_SVSInputWordLength',
    'DISPID_SVEventInterests', 'DISPID_SVSCurrentStreamNumber',
    ...
    'SPRECORESULTTIMES', 'SAFTDefault', 'Speech_Max_Pron_Length',
    'SPRULESTATE', 'ISpeechRecoResult', 'SpeechVisemeFeature',
    'DISPID_SVSVisemeId', 'SPSNoun', 'DISPID_SVEPhoneme',
    'DISPID_SRSCurrentStreamPosition', 'ISpNotifySource',
    'SpeechDiscardType', '_ISpeechVoiceEvents', 'DISPID_SRCResume',
    'DISPID_SpeechAudioFormat', 'SREHypothesis',
    'SPEI_RECO_STATE_CHANGE', 'SECFIgnoreWidth', 'SRSEDone',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPEI_PROPERTY_NUM_CHANGE',
    'ISpeechPhraseProperties', 'SVSFNLPSpeakPunc', 'DISPIDSPTSI',
    'SPDKL_DefaultLocation', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SWFEChannels',
    'DISPID_SpeechMMSysAudio', 'SRTExtendableParse', 'SDTRule',
    'SPWF_SRENGINE', 'SPPS_RESERVED4', 'DISPID_SRGDictationLoad',
    'ISpeechAudio', 'DISPID_SPEs_NewEnum',
    'DISPID_SRSetPropertyNumber', 'DISPID_SAVolume',
    'DISPID_SPIStartTime', 'SECLowConfidence',
    'DISPID_SPEPronunciation', 'SREPropertyStringChange',
    'DISPID_SABIMinNotification', 'SPCATEGORYTYPE', 'SVP_9',
    'STSF_CommonAppData', 'SGDSInactive', 'SVP_1', 'SpeechRunState',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechXMLRecoResult', 'SREPrivate', 'eLEXTYPE_PRIVATE4',
    'DISPID_SGRSTPropertyId', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechWordType', 'SVSFParseSapi', 'SAFTADPCM_22kHzMono',
    'Speech_Default_Weight', 'SPFM_NUM_MODES', 'ISpRecoContext',
    'SPSHT_EMAIL', 'DISPID_SRCERequestUI', 'SDKLCurrentUser',
    'SAFT48kHz16BitMono', 'ISpStreamFormatConverter',
    'ISpeechGrammarRules', 'DISPID_SPIEnginePrivateData',
    'SP_VISEME_11', 'SVEStartInputStream', 'DISPID_SGRsCommit',
    'ISpeechRecoContext', 'SPPS_Unknown', 'eLEXTYPE_PRIVATE12',
    'SPAS_PAUSE', 'ISpProperties', 'DISPID_SPEDisplayText',
    'SVESentenceBoundary', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCState',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SOTMatchesAttributes',
    'DISPID_SGRsCommitAndSave', 'SAFT44kHz16BitStereo',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPERetainedStreamOffset',
    'SAFT11kHz16BitMono', 'DISPID_SOTCreateInstance',
    'eLEXTYPE_PRIVATE1', 'SPAR_Unknown', 'DISPID_SRRAudioFormat',
    'SpInprocRecognizer', 'SPGS_EXCLUSIVE', 'DISPID_SGRSRule',
    'DISPID_SOTs_NewEnum', 'DISPID_SLGetWords', 'ISpeechCustomStream',
    'ISpPhraseAlt', 'SVEAllEvents', 'DISPID_SpeechCustomStream',
    'SPCONTEXTSTATE', 'SPBINARYGRAMMAR', 'DISPID_SRCCreateGrammar',
    'DISPID_SOTCId', 'eLEXTYPE_PRIVATE17', 'DISPID_SpeechVoice',
    'SDA_One_Trailing_Space', 'SVSFParseMask', 'SpeechVoicePriority',
    'DISPID_SVAudioOutputStream', 'SGSEnabled', 'SFTSREngine',
    'SPLO_STATIC', 'DISPID_SpeechPhraseRules',
    'SpeechVoiceSkipTypeSentence', 'SpLexicon',
    'DISPID_SpeechRecoContextEvents', 'tagSTATSTG', 'ISpRecognizer3',
    'DISPID_SRCEFalseRecognition', 'SPPHRASE',
    'DISPID_SVSInputSentenceLength', 'ISpeechLexiconPronunciations',
    'DISPID_SPPValue', 'SSTTWildcard', 'DISPID_SABIBufferSize',
    'ISpeechMemoryStream', 'SPWORDLIST', 'SLODynamic', 'SRAONone',
    'SVEVoiceChange', 'ISpeechVoiceStatus', 'ISpeechLexiconWords',
    ...
    'SRAORetainAudio', 'SPVISEMES', 'ISpRecognizer2',
    'DISPID_SRRTTickCount', 'ISpVoice', 'SPWT_LEXICAL',
    ...
    'DISPID_SPILanguageId', 'SpeechEngineProperties', 'SP_VISEME_0',
    'DISPID_SpeechPhraseRule', 'DISPID_SPIRule', 'SGRSTTTextBuffer',
    'ISpXMLRecoResult', 'SAFTADPCM_8kHzStereo', 'SRARoot',
    'SPEI_HYPOTHESIS', 'DISPID_SRSClsidEngine',
    'SpeechDisplayAttributes', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SDKSetBinaryValue', 'DISPID_SDKSetLongValue',
    'eLEXTYPE_MORPHOLOGY', 'SPCT_COMMAND', 'SINoise',
    'SPRST_INACTIVE', 'DISPID_SRCEAudioLevel',
    'SpeechTokenShellFolder', 'SPFM_OPEN_READWRITE',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRGRecoContext',
    'DISPID_SABIEventBias',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechRecoResult', 'DISPID_SPIGetText', 'SASPause',
    'DISPID_SGRInitialState', 'DISPID_SRSAudioStatus',
    'DISPID_SGRSTPropertyValue', 'SPCT_DICTATION',
    'SWPUnknownWordPronounceable', 'SPAUDIOSTATE',
    'DISPID_SRCSetAdaptationData', 'SAFT16kHz16BitMono',
    'ISpRecoResult', 'SVP_17', 'DISPID_SLPPhoneIds',
    'ISpeechAudioFormat', 'SGSDisabled', 'ISpeechGrammarRule',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRGetPropertyString',
    'SAFT22kHz8BitMono', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPBOOKMARKOPTIONS', 'DISPID_SVSpeak', 'ISpeechRecognizerStatus',
    'DISPID_SPPId', 'DISPID_SASFreeBufferSpace', 'eLEXTYPE_PRIVATE6',
    'SRAInterpreter', 'SRSActive', 'SAFTCCITT_ALaw_22kHzStereo',
    'SBOPause', 'DISPID_SpeechRecoResult2', 'SECFNoSpecialChars',
    ...
    'SPPS_Noncontent', 'SPWORDPRONUNCIATION', 'SPRS_ACTIVE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SSFMCreateForWrite',
    'ISpEventSource', 'SPEI_END_INPUT_STREAM', 'ISpNotifySink',
    'SPPS_Verb', 'SPSHORTCUTPAIRLIST', 'SINoSignal',
    ...
    'SPRULE', 'SpeechTokenKeyUI', 'SP_VISEME_5',
    'DISPID_SRCEHypothesis', 'DISPID_SPEAudioStreamOffset',
    'SPWF_INPUT', 'SVF_Stressed', 'SITooQuiet', 'STCInprocServer',
    'SRCS_Disabled', 'SPVPRI_NORMAL', 'SPSERIALIZEDRESULT',
    'DISPID_SABufferNotifySize', 'SAFT16kHz16BitStereo',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVEVoiceChange',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SGRId', 'SP_VISEME_1',
    'SLOStatic', 'ISpeechRecognizer', 'DISPID_SpeechPhraseInfo',
    'DISPID_SLWsCount', 'DISPID_SGRSTRule',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRRAlternates',
    'DISPID_SpeechLexiconPronunciation', 'SPSMF_SAPI_PROPERTIES',
    'SPAR_Medium', 'SpTextSelectionInformation', 'SPEI_MIN_TTS',
    'STSF_FlagCreate', 'DISPID_SPRNumberOfElements', 'SPSHT_OTHER',
    'DISPID_SRCCmdMaxAlternates', 'SPPS_Noun', 'SAFT8kHz8BitMono',
    'DISPID_SRCEAdaptation', 'DISPID_SWFEBlockAlign',
    'SpeechAllElements', 'DISPID_SLWWord', 'SAFTGSM610_22kHzMono',
    'SpObjectToken', 'SPEI_START_INPUT_STREAM', 'SPSEMANTICFORMAT',
    'eLEXTYPE_PRIVATE8', 'SECFIgnoreCase',
    'DISPID_SpeechObjectTokenCategory', 'SVSFPersistXML', 'SRTReSent',
    'SPEI_END_SR_STREAM', 'DISPID_SLPs_NewEnum',
    'ISpeechObjectTokenCategory', 'SAFTADPCM_44kHzMono',
    ...
    'SPEI_SR_RETAINEDAUDIO', 'SDTAll', 'SVP_2', 'ISpeechPhraseInfo',
    'SAFT22kHz16BitStereo', 'DISPID_SpeechLexiconWord',
    'SpeechCategoryRecognizers', 'SpeechAudioProperties',
    'SPSNotOverriden', 'SREStateChange', 'SpeechStreamFileMode',
    'tagSPPROPERTYINFO', 'ISpeechAudioBufferInfo',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVEEnginePrivate',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechResourceLoader',
    'SVSFDefault', 'eLEXTYPE_PRIVATE19', 'SpVoice', 'SPSSuppressWord',
    'SP_VISEME_6', 'Speech_StreamPos_RealTime', 'DISPID_SFSClose',
    'DISPID_SGRSTWeight', 'SpeechPropertyResourceUsage',
    'SAFTADPCM_22kHzStereo', 'SPLEXICONTYPE', 'STCAll',
    'DISPID_SVRate', 'DISPID_SGRAddResource', 'SRTAutopause',
    'SAFT48kHz8BitStereo', 'SRTSMLTimeout', 'SVP_12', 'SVP_16',
    'DISPID_SLGenerationId', 'SPPROPERTYINFO', 'DISPID_SGRClear'
]

_check_version('1.1.14', 1663101558.174439)
